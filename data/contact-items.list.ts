...
export const contactInformationList: ContactInformation[] = [
    new ContactInformation(
        ...
        '#',
        'Xing',
        'hover:text-xing hover:border-xing',
    ...
    new ContactInformation(
        ...
        '#',
        'LinkedIn',
        'hover:text-linkedin hover:border-linkedin',
    ...
    new ContactInformation(
        ...
        '#',
        'GitHub',
        'hover:text-github hover:border-github',
    ...
    new ContactInformation(
        ...
        '',
        'Tutanota',
        'hover:text-tutanota hover:border-tutanota',
        '',
        undefined,
        (e) => {
    ...
    new ContactInformation(
        ...
        '#',
        'Calendly',
        'hover:text-calendly hover:border-calendly',
