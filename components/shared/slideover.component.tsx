        ...
        >
            ...
            -->*/}
                    <div
                        ...
                        className={
                            'absolute inset-0 bg-gray-500 bg-opacity-75 transition-opacity transition duration-500 ease-in-out'
                        }
                    />
                ...
                -->*/}
                        <div
                            className={
                                (slideOverState ? 'translate-x-0' : 'translate-x-full') +
                                ' transform transition ease-in-out duration-500 sm:duration-700 relative w-screen max-w-md transition duration-500 ease-in-out'
                            }
                        >
                            {/*<!--
                    ...
                    -->*/}
                            <div
                                className={
                                    (slideOverState ? 'opacity 0' : 'opacity-100') +
