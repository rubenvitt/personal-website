    ...
    return <div className="py-12 bg-white border-b border-gray-100">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="lg:text-center">
                <p className="text-base leading-6 text-orange-600 font-semibold tracking-wide uppercase">{t('developer')}</p>
                ...
                <ul className="md:grid md:grid-cols-2 md:col-gap-8 md:row-gap-10">
                    ...
                    <li className="mt-10 md:mt-0">
                        <div className="flex">
                            ...
                            <div className="ml-4">
                                <h4 className="text-lg leading-6 font-medium text-gray-900">{t('summary.mindset')}</h4>
                                <p className="mt-2 text-base leading-6 text-gray-500">
